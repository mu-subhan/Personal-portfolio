export const navItems = [
  ...
  export const gridItems = [
    ...
    {
      id: 5,
      title: "Currently Focusing on Attractive building UI",
  ...
  export const projects = [
    {
      id: 1,
      title: "Cloudly Store",
      des: "Clodly Store for saving your's files and images in the cloud and share it with your friends.",
      img: "/p1.svg",
  ...
  export const testimonials = [
    {
      quote:
        "Collaborating with Subhan was an absolute pleasure. His professionalism, promptness, and dedication to delivering exceptional results were evident throughout our project. Subhan's enthusiasm for every facet of development truly stands out. If you're seeking to elevate your website and elevate your brand, Subhan is the ideal partner.",
